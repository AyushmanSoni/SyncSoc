        ...
        <div>
          ...
          <div className="mt-8 mb-12 lg:mb-4">
            ...
            <p className="flex items-center">
              <a
                href="https://www.linkedin.com/in/ayushman-soni/" // Replace with the actual LinkedIn URL
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-white hover:underline"
              >
                Ayushman Soni <BsLinkedin className="ml-2" />
              </a>
            </p>

            <p className="flex mt-1 items-center">
              <a
                href="https://www.linkedin.com/in/aaditya-goyal-87a2b224b" // Replace with the actual LinkedIn URL
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-white hover:underline"
              >
                Aaditya Goyal <BsLinkedin className="ml-2" />
              </a>
            </p>
            <p className="flex mt-1 items-center"> 
              <a
                ...
                className="flex items-center text-white hover:underline"
              >
                Siddharth Singh <BsLinkedin className="ml-2" />
              </a>
            </p>
          </div>
        </div>
