...
const HeroSection = () => {
  ...
  const handleNavigateToTeam = () => {
    const societyName = 'virtuosi'; // Replace 'music' with the dynamic society name if needed
    ...
    <div className="relative bg-white h-screen">
      ...
      <div className="flex justify-between items-center px-24 py-6">
        <div className="flex items-center space-x-4">
          ...
          />
          <div className="text-2xl font-medium text-[#683B2B]">Virtuosi</div>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-24 h-full">
        ...
        <div className="md:w-1/2 mb-28">
          <h1 className='text-4xl md:text-6xl font-bold text-[#683B2B]'>Rock</h1>
          <h1 className="text-4xl mt-4 md:text-6xl font-bold text-[#683B2B]">
            &<br/>
            <span className="text-[#D49E8D] mt-4">Roll!</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-500 mt-4 w-[80%]">
            Welcome to our melodious music society, where every note resonates with passion, creating harmony that moves the soul.
          </p>
